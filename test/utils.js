...
describe('Utils', function() {
  ...
  describe('#privateKeyToAESKey', function() {
    it('should be ok', function() {
      var privKey = new PrivateKey('09458c090a69a38368975fb68115df2f4b0ab7d1bc463fc60c67aa1730641d6c').toString();
  ...
  describe('#verifyRequestPubKey', function() {
    ...
    it('should fail to check a request pub key with wrong key', function() {
      ...
      var xPrivKey2 = new HDPrivateKey();
      var xPubKey2 = new HDPublicKey(xPrivKey2);
